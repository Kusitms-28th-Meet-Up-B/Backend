...
public class ManagerController {
    ...
    public ResponseEntity<BaseResponse> deleteTempProgram(
        ...
        //사용자 로그인 들어오면
        adminService.deleteTempProgram(programId);
    ...
    public ResponseEntity<BaseResponse> saveProgram(
        ...
        this.adminService.postProgram(programPostReq);
    ...
    public ResponseEntity<BaseResponse<ProgramPostReq>> findTempProgram() {
        //사용자 로그인 들어오면
        return ResponseEntity.ok(new BaseResponse<>(this.adminService.getTempProgram()));
    }
}
