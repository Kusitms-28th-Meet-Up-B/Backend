...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain SecurityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .requestMatchers("/reviews/delete").hasAnyRole(Role.USER.getValue(),Role.MANAGER.getValue())
                ...
                .requestMatchers("/archives/delete").hasAnyRole(Role.USER.getValue(),Role.MANAGER.getValue())
